...
print_text_centralized('Aplicando filtro com opderador lógico | Seminario > 8 e prova > 3', 72, 3)
imprimir_linha(3)
# print(df.dtypes) -> visualizando os tipos de dados
# print(df.columns) -> visualizando as colunas existentes
# print(df['Aluno']) -> visualizando um dado especifico
# print(df.describe()) -> dados estatísticos
# print(df.sort_values(by='Seminário')) -> ordenando valores com um valor específico
# print(df.loc[3]) -> acessando índice especifico
